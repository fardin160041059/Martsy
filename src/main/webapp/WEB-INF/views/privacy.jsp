...
<div class="hero-image"
     style="font-family: 'Lato', sans-serif; color: #000000;background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(/martsy/resources/images/privacybg.jpg)">
    <div class="hero-text">
        <h1 class="home-header" style="color: rgba(213,213,213,0.79)">Privacy Policy</h1>
    </div>
</div>
...
<div class="container" style="font-family: 'Teko', sans-serif; font-size: x-large; color: rgb(25,25,25)">
    ...
    <p>Martsy ("us", "we", or "our") operates the martsy.com website (the "Service").</p>
    ...
    <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
        ...
        Privacy Policy have the same meanings as in our Terms and Conditions, accessible from martsy.com</p>
    ...
    <p>Martsy uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>If you are located outside Bangladesh and choose to provide information to us, please note that we transfer the
        data, including Personal Data, to Bangladesh and process it there.</p>
    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
        that transfer.</p>
    <p>Martsy will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
    ...
    <p>Martsy may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Martsy</li>
    ...
    <ul>
        <li>By email: martsy@gmail.com</li>
