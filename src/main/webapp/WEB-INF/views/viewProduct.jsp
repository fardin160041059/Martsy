...
<div class="hero-image" style="font-family: 'Lato', sans-serif; color: #000000;background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(/martsy/resources/images/productbg.jpg)">
    <div class="hero-text">
        <h1 class="home-header" style="color: #ff9b3cdb">Product Detail</h1>
        <p class="lead">Here is the detail information of the product!</p>
    </div>
</div>
<section class="ftco-section bg-light">
    <div class="container" ng-app="cartApp" style="font-family: 'Teko', sans-serif; font-size: 20px; color: #000000">
        <div class="row">
            ...
            <div class="col-lg-6 product-details pl-md-5">
                <h3 style="font-size: 36px">${product.productName}</h3>
