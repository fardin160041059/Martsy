...
<jsp:useBean id="now" class="java.util.Date" />
    ...
    <div class="hero-image" style="font-family: 'Lato', sans-serif; color: #000000;background-image:linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(/martsy/resources/images/checkoutbg.jpg)">
        <div class="hero-text">
            <h1 class="home-header" style="color: rgba(213,213,213,0.79)">Checkout</h1>
        </div>
    </div>
<div class="container-wrapper" style="font-family: 'Teko', sans-serif; color: #000000; font-size: large">
            ...
            <div class="row">
                ...
                <form:form commandName="order" class="form-horizaontal">
                    ...
                    <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 co-md-offset-3">
                        ...
                        <br><br>
                        <button class="btn btn-primary pull-left" name="_eventId_backToCollectShippingDetail">Back</button>
                        <input type="submit" value="Submit Order" class="btn btn-success"
                               name="_eventId_orderConfirmed"/>
                        <button class="btn btn-danger pull-right" name="_eventId_cancel">Cancel</button>
                    </div>
                </form:form>
